...
- 2026年3月28日
    - 画像は日本語名含まれると、期待通りアップできない模様。
    - スクリーンショット取得用のアプリ（ShareXなど）利用してで、ファイル名を「スクリーンショット 2026-01-20 050748.png」でなく「screenshot 2026-01-20 050748.png」での保存へ調整、これでスクリーンショット後、Notion貼り付け、Zennまで問題ないと思われます。
